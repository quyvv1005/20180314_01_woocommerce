...
if ( ! function_exists( 'retail_setup' ) ) :
	...
	function retail_setup() {
		 ...
		 * If you're building a theme based on retail, use a find and replace
		 * to change 'retail' to the name of your theme in all the template files.
		 */
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Primary', 'retail' ),
		) );
...
function retail_content_width() {
	...
	$GLOBALS['content_width'] = apply_filters( 'retail_content_width', 640 );
}
...
function retail_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'retail' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'retail' ),
